...
//     try {
//       const response = await axios.get(`http://localhost:9090/api/student_modules/getmodules/${studentId}`);
...
//           >
//             <img
//               src={module.image || 'default-image-path.jpg'} // Use default image if module image is missing
//               alt={module.name}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredModules.length > 0 ? (
          filteredModules.map((module) => (
            ...
            >
              {/* <img
                src={module.image || 'default-image-path.jpg'}
                alt={module.name}
                className="w-full h-40 object-cover rounded-lg"
              /> */}
               {/* <img
              src={module.image ? `http://localhost:9090/uploads/${module.image}` : '/images/default-placeholder.jpg'}
              alt={module.name}
              className="w-full h-40 object-cover rounded-lg"
            /> */}
            <img
